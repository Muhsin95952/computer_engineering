...
INSERT INTO Type (type_id, fee) VALUES
('Associate', 60),
('Junior', 150),
('Senior', 300),
('Social', 50);
...
INSERT INTO tournment (tour_id, tour_name, tour_type) VALUES
(24, 'Leeston', 'Social'),
(25, 'Kaiapoi', 'Social'),
(36, 'WestCoast', 'Social'),
(38, 'Canterburry', 'Open'),
...
INSERT INTO Team (team_name, prictice_night, manager) VALUES
('Team A', 'Tuesday', 239),
('Team B', 'Monday', 153);

-- Inserting data into the 'Member' table
INSERT INTO Member (member_id, last_name, first_name, handicap, gender, member_type, team, coach, phone_number, join_date) VALUES
...
INSERT INTO Entry (member_id, tour_id, entry_year) VALUES
(118, 24, 2013),
(228, 24, 2014),
(235, 25, 2014),
(235, 36, 2012),
